...
public class LoginPage extends BasePage {
	...
	System.out.println("Credentials are:" +  Credential.getEmailID()  + " " + Credential.getPassword());
		elementActions.waitForElementPresent(username);
		elementActions.doSendKeys(username, Credential.getEmailID());
		elementActions.doSendKeys(password,  Credential.getPassword());
